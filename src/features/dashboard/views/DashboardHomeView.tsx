...
export function DashboardHomeView() {
  ...
  return (
    <div className="flex flex-col flex-1 gap-1 lg:gap-1.5 max-w-7xl mx-auto w-full h-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 shrink-0 mt-1">
      ...
      {/* Pro Banner */}
      <div className="bg-gradient-to-r from-teal-700 to-sky-500 rounded-lg px-4 py-2.5 flex flex-col md:flex-row items-center justify-between gap-2 shadow-lg overflow-hidden relative shrink-0 mt-1">
      ...
      <div className="flex flex-col items-center justify-center pt-1.5 pb-1 shrink-0">
