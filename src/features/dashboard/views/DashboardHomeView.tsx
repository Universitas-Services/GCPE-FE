...
export function DashboardHomeView() {
  ...
  return (
    <div className="flex flex-col flex-1 gap-1 lg:gap-1.5 max-w-7xl mx-auto w-full h-full">
      {/* All content - pushed to bottom together */}
      <div className="mt-auto shrink-0 flex flex-col gap-1.5">
        {/* Header / Greeting */}
        ...
        {/* Pro Banner */}
        <div className="bg-gradient-to-r from-teal-700 to-sky-500 rounded-lg px-4 py-2.5 flex flex-col md:flex-row items-center justify-between gap-2 shadow-lg overflow-hidden relative">
